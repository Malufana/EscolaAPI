...
export function Footer(){
    return(
        <footer className={estilos.footer}>
            ...
            <div className={estilos.fotter_container}>
                
                {/* Informações da escola */}
                <section className={estilos.school-info}>
                ...
                {/* Redes sociais */}
                <section className={estilos.social-media}>
                <h4>Redes Sociais</h4>
                <div className={estilos.social-icons}>
            ...
            {/* Direitos autorais */}
            <div className={estilos.footer-bottom}>
